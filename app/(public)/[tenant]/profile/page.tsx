            ...
            {activeTab === "overview" && (
              <>
                ...
                {userData.bookings.filter(b => b.status === "upcoming").length > 0 && (
                  <div className="bg-white rounded-2xl p-5 shadow-sm">
                    <h3 className="font-bold text-gray-800 mb-4">התור הקרוב</h3>
                    {userData.bookings.filter(b => b.status === "upcoming").slice(0, 1).map((booking) => (
                      <div key={booking.id} className="flex items-center gap-4 p-3 bg-blue-50 rounded-xl">
                ...
                <div className="bg-white rounded-2xl p-5 shadow-sm">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <span className="text-gray-800 font-medium">סטריק שבועי</span>
                      </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4 mt-6">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                  ...
                  <span className="text-gray-700" dir="ltr">{userData.phone}</span>
                </div>
                <hr className="my-2" />
